...
<body class="childrenBody">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="roleId">
					...
					<#if roles??> 
					<#list roles as info>
						<#if ad.roleId==info.roleId>
							<option value="${info.roleId!'' }" selected>${info.roleName!'' }</option>
						</#if>
						<#if ad.roleId!=info.roleId >
	...
	<script type="text/javascript" src="${basePath}/static/js/admin/personalData.js"></script>
</body>
</html>