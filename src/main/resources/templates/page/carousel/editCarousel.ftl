...
<body class="childrenBody">
	...
	<input type="hidden" name="id" value="${carousel.id }"/>
		...
		<label class="layui-form-label">新闻封面</label>
		  <div class="layui-input-block">
			...
			<img class="layui-upload-img" id="preview" style="width: 150px;margin-top: 5px" src="${basePath}/file/showPic?fileName=${carousel.imgurl }">
			<p id="uploadError"></p>
	...
	<script type="text/javascript" src="${basePath}/static/js/carousel/editCarousel.js"></script>
</body>
</html>