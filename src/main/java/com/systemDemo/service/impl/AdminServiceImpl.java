...
import com.systemDemo.mapper.AdminMenusMapper;
import com.systemDemo.mapper.TbAdminMapper;
import com.systemDemo.mapper.TbMenusMapper;
import com.systemDemo.mapper.TbRolesMapper;
import com.systemDemo.mapper.TbRolesMenusMapper;
import com.systemDemo.pojo.Menu;
import com.systemDemo.pojo.TbAdmin;
import com.systemDemo.pojo.TbAdminExample;
import com.systemDemo.pojo.TbAdminExample.Criteria;
import com.systemDemo.pojo.TbMenus;
import com.systemDemo.pojo.TbMenusExample;
import com.systemDemo.pojo.TbRoles;
import com.systemDemo.pojo.TbRolesExample;
...
import com.systemDemo.pojo.XtreeData;
...
public class AdminServiceImpl implements AdminService {
	...
	public List<Menu> selMenus(TbAdmin admin) {
		...
		com.systemDemo.pojo.TbRolesMenusExample.Criteria criteria = example.createCriteria();
	...
	public List<TbMenus> selXtreeData(TbAdmin admin) {
		...
		if(!roleId.equals(Long.valueOf("-1"))){
			...
			com.systemDemo.pojo.TbRolesMenusExample.Criteria criteria = rolemenusexample.createCriteria();
			criteria.andRoleIdEqualTo(roleId);
	...
	public TbRoles selRoleByRoleName(String roleName) {
		TbRolesExample example = new TbRolesExample();
		com.systemDemo.pojo.TbRolesExample.Criteria criteria = example.createCriteria();
	...
	public TbAdmin selAdminByUserName(String username) {
		TbAdminExample example = new TbAdminExample();
		com.systemDemo.pojo.TbAdminExample.Criteria criteria = example.createCriteria();
		criteria.andUsernameEqualTo(username);
	...
	public TbMenus selMenuByTitle(String title) {
		TbMenusExample example=new TbMenusExample();
		com.systemDemo.pojo.TbMenusExample.Criteria criteria = example.createCriteria();
